...
export class SpawnManager {
  constructor(events,renderer) { this.events=events;this.renderer=renderer;this.ai=new EnemyAiSystem(renderer);this.entities=new Map();this.defeated=new Set();this.definitions=Object.values(ZONES).flatMap((zone)=>zone.spawns.map((entry)=>({...entry,zoneId:zone.id}))); }
